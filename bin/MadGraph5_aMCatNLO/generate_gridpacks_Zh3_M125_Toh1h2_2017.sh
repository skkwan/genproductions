...
# Non-cascade #
###############
process_dir_noncascade="Zh3_M125_Toh1h2/non_cascade/"
...
do
    masspoint_str="Zh3_M125_Toh1h2_M${H1MASS}_M${H2MASS}"
...
# Cascade #
###########
process_dir_cascade="Zh3_M125_Toh1h2/cascade/"
masspoints_cascade="cards/production/2017/13TeV/bbtautau_final_state/cascade_masspoints.txt"

while IFS=", " read H1MASS H2MASS;
do
    masspoint_str="Zh3_M125_Toh1h2_M${H1MASS}_M${H2MASS}_h2_Toh1h1"
